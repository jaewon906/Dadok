...
const initialState = {
    ...
    discount: 0,
    // 모달창 on off
    loginModalOnOff: false,
    subscribeModalOnOff: false
...
const dataSet = createSlice({
    ...
    reducers: {
        ...
        loginModalRdc: (state) => {
            state.loginModalOnOff = !state.loginModalOnOff;
        },

        subscribeModalRdc: (state) => {
            state.subscribeModalOnOff = !state.subscribeModalOnOff;
        }
    },
});
